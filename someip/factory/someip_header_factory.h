 ...
 *
 */
#ifndef SOMEIP_FACTORY_SOMEIP_HEADER_FACTORY_H_
#define SOMEIP_FACTORY_SOMEIP_HEADER_FACTORY_H_

#include <cstdint>
#include <memory>
#include <vector>

#include "someip/factory/Isomeip_header_factory.h"
...
class SomeIpHeaderFactory : public ISomeIpHeaderFactory {
 public:
   ...
   */
  std::shared_ptr<SomeIpHeader> CreateEvent(
...
#endif  // SOMEIP_FACTORY_SOMEIP_HEADER_FACTORY_H_
